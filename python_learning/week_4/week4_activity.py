...
print(result[0:4]) #prints the first 4 letters
print(result[-1]) #prints last letter
...
print(prepRally.find('cheerleaders'))#print -1 because cheerleaders is not in the string
...
print(sentence4.split(".")) 
#splits the sentence into a list with no commas
print(sentence4.split("a")) 

#conatenation words in python repetition 15 times
